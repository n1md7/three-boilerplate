...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function xl(){return new fi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ea(),fragmentShader:`
		...
		`,blending:qn,depthTest:!1,depthWrite:!1})}function yl(){return new fi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ea(),fragmentShader:`
...
`].filter(Ms).join(`
`)),r=zo(r),r=Cl(r,t),r=Ll(r,t),a=zo(a),a=Cl(a,t),a=Ll(a,t),r=Pl(r),a=Pl(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
